...
class GetNurseInfoUseCase extends UseCase<NurseInfo, NurseRegisterRequest> {
  final NurseDataControlRepository _repository;

  GetNurseInfoUseCase(this._repository);
  ...
  Future<Stream<NurseInfo>> buildUseCaseStream(NurseRegisterRequest? params) async {
    ...
    try {
      NurseInfo nurseInfo = await _repository.getNurseInfo(params!);
